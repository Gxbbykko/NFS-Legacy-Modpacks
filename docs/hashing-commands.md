...
Rollback validation follows the standardized Release 2.0 workflow.
...
Confirm that the RestoreData directory has been created:

```powershell
Get-ChildItem ".\_LegacyInstaller\RestoreData" -Force
```
