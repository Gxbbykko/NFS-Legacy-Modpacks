...
SolidCompression=no
WizardStyle=modern
WizardImageFile=C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Images\wizard.bmp
WizardSmallImageFile=C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Images\header.bmp
SetupIconFile=C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Images\nfs_icon.ico
Uninstallable=yes
...
[Files]
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\arc.exe"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\NFSUC.arc"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\Splash.exe"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Images\splash.png"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\ArcRunner.exe"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\LegacyUI.exe"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\D3DCompiler_47_cor3.dll"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\PenImc_cor3.dll"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\PresentationNative_cor3.dll"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\vcruntime140_cor3.dll"; Flags: dontcopy
Source: "C:\Users\Gabriel\Desktop\NFSUC_Modpack\InstallerProject\Tools\wpfgfx_cor3.dll"; Flags: dontcopy
...
function IsNFSUCInstallReady(BaseDir: String): Boolean;
var
  ExePath: String;
begin
  Result := False;
  ...
  if not FileSizeMatches(ExePath, 10589456) then Exit;
  if not IsLargeAddressAware(ExePath) then Exit;

  if not FileSizeMatches(AddBackslash(BaseDir) + 'FRONTEND\FrontB1.lzc', 131587) then Exit;
  if not FileSizeMatches(AddBackslash(BaseDir) + 'GLOBAL\GlobalB.lzc', 6134885) then Exit;
  if not FileSizeMatches(AddBackslash(BaseDir) + 'GLOBAL\InGameB.lzc', 520767) then Exit;
  if not FileSizeMatches(AddBackslash(BaseDir) + 'LANGUAGES\English_Global.bin', 168284) then Exit;
...
begin
  ...
  WriteLegacyUIState('preparing', '5', 'Preparing Undercover installation environment...');
...
begin
  ...
  LogText := '';
  WriteLegacyUIState('extracting', '10', 'Extracting Undercover archive payload...');
  ...
  WizardForm.StatusLabel.Caption := 'Installing Undercover Legacy Modpack...';
  ...
  repeat
    ...
    WriteLegacyUIState(
      ...
      'Extracting Undercover archive payload...'
    );
...
begin
  ...
  begin
    if not IsNFSUCInstallReady(WizardDirValue()) then
    begin
      MsgResult :=
        MsgBox(
          'Your game does not appear to be patched to the required state.'#13#10#13#10 +
          '{#MyAppName} requires:'#13#10 +
          '• Need for Speed Undercover patched to the required version'#13#10 +
