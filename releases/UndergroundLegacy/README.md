# Underground Legacy Releases

This folder contains release builds and supporting documentation for **Need for Speed: Underground (2003)** as part of the **NFS Legacy Modpacks** project.

This release represents the reference implementation of the validated Release 2.0 installer architecture, providing standardized installation, deterministic rollback, and restoration-safe uninstallation across all supported titles.
...
```txt
UndergroundLegacy_v<version>.exe
Gallery/
README.md
```
...
Every Underground Legacy release includes:
...
* You must legally own **Need for Speed: Underground**.
* This release serves as the reference implementation for the standardized Release 2.0 installer architecture used throughout the NFS Legacy Modpacks project.
