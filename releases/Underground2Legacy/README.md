# Underground 2 Legacy Releases

This folder contains release builds and supporting documentation for **Need for Speed: Underground 2 (2004)** as part of the **NFS Legacy Modpacks** project.
...
```txt
Underground2Legacy_v<version>.exe
Gallery/
README.md
```
...
* HD MOVIES package installation
...
Every Underground 2 Legacy release includes:
...
* You must legally own **Need for Speed: Underground 2**.
* The standard release includes the validated **HD MOVIES** package as part of the complete Legacy Modpack.
