...
This folder contains release builds and supporting documentation for **Need for Speed: Undercover (2008)** as part of the **NFS Legacy Modpacks** project.
...
```txt
UndercoverLegacy_v<version>.exe
Gallery/
README.md
```
...
* Optional MOVIES package selection
...
Every Undercover Legacy release includes:
...
* Optional MOVIES package installation
...
* You must legally own **Need for Speed: Undercover**.
* The optional **MOVIES** package can be selected during installation and is documented in the gallery.
